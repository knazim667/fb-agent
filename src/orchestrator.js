...
async function runAssistantSession(options = {}) {
  ...
  try {
    ...
    startOperatorConsole({
      ...
      interpretObjectiveForBrowser: (payload, options) => interpretObjectiveForBrowser(payload, options),
      ...
      createNewPost,
      createFeedPost,
      openPostComposer: (groupId = null) => openPostComposer(browser.page, { groupId }),
      commentOnRedditPost: (payload) => commentOnRedditPost(browser.page, payload),
      ...
      submitComposerPost: (text, imagePath = null) => submitComposerPost(browser.page, text, imagePath),
      upsertAgentState,
      humanJitter,
      inspectRedditSession: () => inspectRedditSession(browser.page),
      observeRedditPage: (optionsArg) => observeRedditPage(browser.page, optionsArg),
